var html= '<footer id="footer" class="container-fluid bg-dark" style="background-color:black;">  '+
                 ...
                 ' </div>'+
                  ...
                  '<div class="d-flex pb-0">'+
                   ' <div class="contact-icon">'+
                    ...
                    '</div>'+
                   ' <div class="contact-info">'+
                    '  <a href="mailto:itsupport@glaciersystemsinc.com" style="margin-left:10px;">itsupport@glaciersystemsinc</a>'+
                    '</div>'+
                 ' </div>'+
             ' </div>'+
            ...
            '</div>  '+
        '</footer>'+
        '<section style="background-color:rgba(0,0,0,0.8);color:white !important;">'+
