var html= '<footer id="footer" class="container-fluid bg-dark" style="background-color:black;">  '+
			...
			As a company with developers and technical experts spread across three continents, we are capable of seamlessly delivering services to our clients and ensuring that their needs are met promptly with the utmost attention to detail. 
		</p>'+
                '</div>'+
                '</div>'+
